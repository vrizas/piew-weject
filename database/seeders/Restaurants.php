...
class Restaurants extends Seeder
{
    ...
    public function run()
    {
        ...
        $user = new User;
        $user->name = "Masakan Padang Pojok";
        $user->password = 'bisnis12345';
        $user->role = 'bisnis';
        $user->email = 'bisnis1@gmail.com';
        $user->save();
